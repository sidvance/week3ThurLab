...
/*
    ...
    Attach another listener that fires your second function when the mouseout event 
...
/*
    ...
    Add a 3rd event listener to sayHelloButton and trigger the sayHello function when 
...
/*  PROBLEM 9
    ...
    On each iteration of the loop, create a new p element. Set its textContent equal the string at the current index (i) and then append 
    the new p element onto the document's body. 
*/
...
/*
    ...
    The function that runs when this request is made will return whatever parameter
    you sent 
...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/catch-me-outside-how-bout-dat')


    .then((res) => {
        let whatTheHell = document.querySelector('#repeat-text');
        whatTheHell.textContent = res.data;
        whatTheHell.style.display = 'block';
...
const queryRequest = () => {
    axios.get('http://localhost:3000/query-test/?test&testing')
    .then((res) => {
    console.log(res.data)
    })
    .catch((theseHands) => {
...
/*
    ...
    (make sure to match the case and 
    ...
    Pass a callback function to the .then. Inside that callback, 
    console log the res.data. 

    Based on what we did earlier to display this type of data, write 
    code that will display the response in your HTML document. 
*/
